...
* Clone the repository. git clone https://github.com/SirSanctified/AirBnB_clone.git
* Open the /AirBnB_clone directory and execute console.py

### Setup

* You need Python interpreter.
IMPORTANT: The project was created in UBUNTU 20.04 LTS and Python 3.8.
...
<a href="https://github.com/SirSanctified">`SirSanctified`</a>
<a href="https://github.com/SifisoSithole">`SifisoSithole`</a>
...
- GitHub at <a href="https://github.com/SirSanctified">`SirSanctified`</a>
- GitHub at <a href="https://github.com/SifisoSithole">`SifisiSithole`</a>
- Twitter at <a href="https://twitter.com/Sir_sanctified">`@Sir_sanctifed`</a>
- Twitter at <a href="https://twitter.com/">`@sifiso`</a>
